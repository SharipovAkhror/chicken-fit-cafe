...
export const PRESET_DISH_IMAGES = [
  ...
  { value: '/menu/somsa.jpg', label: 'Сомса с мясом' },
  ...
  { value: '/menu/shorva.jpg', label: 'Шурпа по-домашнему' },
  { value: '/menu/borscht.jpg', label: 'Борщ домашний' },
  { value: '/menu/shchi-green.jpg', label: 'Щи зелёные' },
  { value: '/menu/lagman.jpg', label: 'Лагман' },
  { value: '/menu/chicken-noodles.jpg', label: 'Куриная лапша' },
  { value: '/menu/meatball-soup.jpg', label: 'Суп с фрикадельками' },
  { value: '/menu/cutlet-homemade.jpg', label: 'Котлеты домашние 1 порция' },
  { value: '/menu/cutlet-homemade-half.jpg', label: 'Котлета домашняя 0.5 порции' },
  { value: '/menu/cutlet-chicken.jpg', label: 'Котлеты куриные 1 порция' },
  { value: '/menu/cutlet-chicken-half.jpg', label: 'Котлета куриная 0.5 порции' },
  { value: '/menu/goulash.jpg', label: 'Гуляш говяжий' },
  { value: '/menu/tefteli.jpg', label: 'Тефтели говяжьи' },
  { value: '/menu/kazan-kabob.jpg', label: 'Казон кабоб' },
  { value: '/menu/tuy-kabob.jpg', label: 'Тўй кабоб' },
